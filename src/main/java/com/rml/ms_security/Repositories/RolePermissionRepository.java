...
public interface RolePermissionRepository extends MongoRepository<RolePermission,String> {
    ...
    public RolePermission getRolePermission(String roleId,String permissionId); //Aca le doy los identificadores de role y permiso para que me busque la intermedia.
}
